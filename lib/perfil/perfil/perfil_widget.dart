  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final perfilUserIndividualResponse = snapshot.data!;
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.network(
                                      UserIndividualCall.avatar(
                                        perfilUserIndividualResponse.jsonBody,
                                      )!,
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Text(
                                          '${UserIndividualCall.nombre(
                                            perfilUserIndividualResponse
                                                .jsonBody,
                                          )} ${UserIndividualCall.apellidos(
                                            perfilUserIndividualResponse
                                                .jsonBody,
                                          )}',
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  await launchURL(
                                      'https://www.paypal.com/donate?campaign_id=YT87DRYJ65HNA');
                                },
                                text: FFLocalizations.of(context).getText(
                                  '13nrgc63' /* Ayúdanos a ayudarte */,
                                ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '3txr46eb' /* Términos y Condiciones de Uso */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'xg8xrf4y' /* Políticas de Investigación */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                            ...
                            children: [
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'ffw1w8y2' /* Comunicaciones Comerciales */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
