...
abstract class FlutterFlowTheme {
  ...
  late Color botonDesactivado;
  late Color azulPerm;
  late Color rellenoCampos;
  late Color rellenoCampo2;
  late Color sintomas;
  late Color reportes;
  late Color resumen;
  late Color lavanda;
  ...
  late Color rosaHome;
  late Color share;
  late Color negroPerm;
  late Color blancoPerm;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF63A4DC);
  late Color secondary = const Color(0xFFFFA1B0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFBABCC1);
  ...
  late Color blancoPerm = Color(0xFFFFFFFF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFA1B0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFDFE4DF);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF1D2428);
  late Color secondaryBackground = const Color(0xFF14181B);
  late Color accent1 = const Color(0xFF1D2428);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
