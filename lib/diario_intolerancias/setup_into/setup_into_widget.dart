                          ...
                          child: Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  15.0, 10.0, 15.0, 5.0),
                              child: Text(
                                '${FFAppState().nombre}${FFLocalizations.of(context).languageCode == 'es' ? ' necesitamos que respondas a las siguientes cuestiones, para terminar de configurar tu Diario de Intolerancias' : ' we need you to answer the following questions, in order to finish setting up your Intolerance Diary'}',
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller: _model
                                            .dropDownFamIntoValueController ??=
                                        FormFieldController<String>(null),
                                    options: [
                                      FFLocalizations.of(context).getText(
                                        '30w8m94m' /* Si */,
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'mczc0q6v' /* ¿Tienes alguna sensibilidadin... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                            ...
                            if ((_model.dropDownInto1Value != null &&
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'hnl0nyce' /* ¿Tienes otra sensibilidadinto... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                            ...
                            if ((_model.dropDownInto2Value != null &&
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'rhzadlt6' /* ¿Tienes otra sensibilidadinto... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                            ...
                            if ((_model.dropDownInto3Value != null &&
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'v8ihp1x1' /* ¿Tienes otra sensibilidadinto... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
