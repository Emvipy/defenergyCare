...
import 'diario_into_carga_desplegables_model.dart';
export 'diario_into_carga_desplegables_model.dart';

class DiarioIntoCargaDesplegablesWidget extends StatefulWidget {
  const DiarioIntoCargaDesplegablesWidget({
    super.key,
  ...
  @override
  State<DiarioIntoCargaDesplegablesWidget> createState() =>
      _DiarioIntoCargaDesplegablesWidgetState();
}

class _DiarioIntoCargaDesplegablesWidgetState
    extends State<DiarioIntoCargaDesplegablesWidget> {
  late DiarioIntoCargaDesplegablesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiarioIntoCargaDesplegablesModel());
