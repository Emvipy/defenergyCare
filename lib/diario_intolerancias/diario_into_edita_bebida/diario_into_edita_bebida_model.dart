...
import 'dart:ui';
import 'diario_into_edita_bebida_widget.dart' show DiarioIntoEditaBebidaWidget;
...
class DiarioIntoEditaBebidaModel
    extends FlutterFlowModel<DiarioIntoEditaBebidaWidget> {
  ...
  // Stores action output result for [Backend Call - API (intolerancia carga plato individual)] action in diario_Into_edita_bebida widget.
  ApiCallResponse? apiCargaPlatoBebida;
  ...
  ApiCallResponse? apiEditaBebida;
