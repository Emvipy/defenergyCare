...
import 'modal_fin_setup_into_model.dart';
export 'modal_fin_setup_into_model.dart';

class ModalFinSetupIntoWidget extends StatefulWidget {
  const ModalFinSetupIntoWidget({super.key});

  @override
  State<ModalFinSetupIntoWidget> createState() =>
      _ModalFinSetupIntoWidgetState();
}

class _ModalFinSetupIntoWidgetState extends State<ModalFinSetupIntoWidget> {
  late ModalFinSetupIntoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalFinSetupIntoModel());
  }
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'gh73idnu' /* Ahora puedes iniciar tu primer... */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Poppins',
                              ...
                              onPressed: () async {
                                ...
                                if ((_model.apiDiarioInto2?.succeeded ??
                                  ...
                                  FFAppState().diarioIntoId =
                                    ...
                                    (_model.apiDiarioInto2?.jsonBody ?? ''),
                                  )!;
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              ...
                              text: FFLocalizations.of(context).getText(
                                '0p54nhwm' /* Lo haré en otro momento */,
                              ),
                              options: FFButtonOptions(
                                width: 300.0,
                                height: 40.0,
