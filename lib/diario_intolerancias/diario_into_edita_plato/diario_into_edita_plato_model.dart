...
import 'dart:ui';
import 'diario_into_edita_plato_widget.dart' show DiarioIntoEditaPlatoWidget;
...
class DiarioIntoEditaPlatoModel
    extends FlutterFlowModel<DiarioIntoEditaPlatoWidget> {
  ...
  // Stores action output result for [Backend Call - API (intolerancia carga plato individual)] action in diario_Into_edita_plato widget.
  ApiCallResponse? apiCargaPlato;
  ...
  // State field(s) for Drop_lacteos1p widget.
  String? dropLacteos1pValue;
  FormFieldController<String>? dropLacteos1pValueController;
