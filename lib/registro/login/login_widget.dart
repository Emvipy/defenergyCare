                                                ...
                                                if ((_model.apiloginCopy
                                                  ...
                                                  if (LoginCall.creadoOk(
                                                    ...
                                                    FFAppState().enfermedadId =
                                                        LoginCall.enfermedadId(
                                                      (_model.apiloginCopy
                                                              ?.jsonBody ??
                                                          ''),
                                                    )!;
                                                    FFAppState().enfermedadTxt =
                                                        LoginCall.enfermedadTxt(
                                                      (_model.apiloginCopy
                                                              ?.jsonBody ??
                                                          ''),
                                                    )!;
                                                        ...
                                                        .authenticate(
                                                            localizedReason:
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                  'l0z7b69x' /* Accede a Defenergy */,
                                                ));
                                              } on PlatformException {
                                                _model.verificacion = false;
                                              }
                                              safeSetState(() {});
                                            }

                                            _shouldSetState = true;
                                            if (_model.verificacion == true) {
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
