  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final homeEmpresaUserIndividualResponse = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.network(
                                        UserIndividualCall.avatar(
                                          homeEmpresaUserIndividualResponse
                                              .jsonBody,
                                        )!,
                                        fit: BoxFit.cover,
                                      ),
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          FFLocalizations.of(context)
                                                      .languageCode ==
                                                  'en'
                                              ? UserIndividualCall.newsEn(
                                                  homeEmpresaUserIndividualResponse
                                                      .jsonBody,
                                                )!
                                              : UserIndividualCall.newsEs(
                                                  homeEmpresaUserIndividualResponse
                                                      .jsonBody,
                                                )!,
                                          width: 360.0,
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          FFLocalizations.of(context)
                                                      .languageCode ==
                                                  'en'
                                              ? UserIndividualCall.friendsEn(
                                                  homeEmpresaUserIndividualResponse
                                                      .jsonBody,
                                                )!
                                              : UserIndividualCall.friendsEs(
                                                  homeEmpresaUserIndividualResponse
                                                      .jsonBody,
                                                )!,
                                          width: 360.0,
