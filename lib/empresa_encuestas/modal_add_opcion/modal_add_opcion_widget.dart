...
class _ModalAddOpcionWidgetState extends State<ModalAddOpcionWidget> {
  late ModalAddOpcionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalAddOpcionModel());

    _model.nombreEsTextController ??= TextEditingController();
    _model.nombreEsFocusNode ??= FocusNode();

    _model.nombreEnTextController ??= TextEditingController();
    _model.nombreEnFocusNode ??= FocusNode();
  }
                    ...
                    Flexible(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'w4u3rb0p' /* Añadir nueva opción al despleg... */,
                        ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.nombreEsTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.nombreEnTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                          ...
                          child: FFButtonWidget(
                            onPressed: ((_model.nombreEsTextController.text ==
                                ...
                                : () async {
                                    ...
                                    if ((_model.apiCreOpcion?.succeeded ??
                                        true)) {
                                      context.safePop();
