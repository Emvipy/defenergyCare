...
import 'chat_mensajes_copy_model.dart';
export 'chat_mensajes_copy_model.dart';

class ChatMensajesCopyWidget extends StatefulWidget {
  const ChatMensajesCopyWidget({
    super.key,
  ...
  @override
  State<ChatMensajesCopyWidget> createState() => _ChatMensajesCopyWidgetState();
}

class _ChatMensajesCopyWidgetState extends State<ChatMensajesCopyWidget> {
  late ChatMensajesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatMensajesCopyModel());
