                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    _model.comida1 =
                                        ReporteIntoStdCargaCall.com1(
                                      (_model.api7diasInto?.jsonBody ?? ''),
                                    );
                                    _model.comida2 =
                                        ReporteIntoStdCargaCall.com2(
                                      (_model.api7diasInto?.jsonBody ?? ''),
                                    );
                                    _model.comida3 =
                                        ReporteIntoStdCargaCall.com3(
                                      (_model.api7diasInto?.jsonBody ?? ''),
                                    );
                                    _model.cena1 = ReporteIntoStdCargaCall.cen1(
                                      (_model.api7diasInto?.jsonBody ?? ''),
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            ...
                            text: FFLocalizations.of(context).getText(
                              '2qygolpa' /* Generar Reporte Intolerancias ... */,
                            ),
                            options: FFButtonOptions(
                              width: 300.0,
                              height: 40.0,
