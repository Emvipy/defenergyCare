...
class _ModalPDFWidgetState extends State<ModalPDFWidget> {
  late ModalPDFModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalPDFModel());
  }
                    ...
                    Flexible(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '5y81sprg' /* Indica el año del que deseas g... */,
                        ),
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'pdbiwk8h' /* Pasados unos minutos, recibirá... */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Poppins',
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'e589x5py' /* (El tiempo puede variar en fun... */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Poppins',
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '9h59e8mg' /* Si no recibes el correo, revis... */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Poppins',
