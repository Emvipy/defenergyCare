                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'egtoim61' /* Bienvenid@ a nuestra tienda vi... */,
                              ),
                      ...
                      child: Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: (_model.apiRequestCompleter ??= Completer<
                                  ApiCallResponse>()
                                ..complete(MarketplaceCategoriasCall.call()))
                              .future,
                          builder: (context, snapshot) {
                            ...
                            final listViewMarketplaceCategoriasResponse =
                                snapshot.data!;

                            return Builder(
                              builder: (context) {
                                final childCategorias = getJsonField(
                                  listViewMarketplaceCategoriasResponse
                                      .jsonBody,
                                  r'''$''',
                                ).toList();
                                if (childCategorias.isEmpty) {
                                  return Image.asset(
