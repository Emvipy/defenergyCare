...
export 'diario_sueno2_model.dart';

class DiarioSueno2Widget extends StatefulWidget {
  const DiarioSueno2Widget({super.key});

  @override
  State<DiarioSueno2Widget> createState() => _DiarioSueno2WidgetState();
}

class _DiarioSueno2WidgetState extends State<DiarioSueno2Widget> {
  late DiarioSueno2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiarioSueno2Model());
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                              ...
                              children: [
                                Flexible(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '13z5fcen' /* ¿Que medicamento has tomado pa... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                              ...
                              children: [
                                Flexible(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'e2ygt0iu' /* Recuerda poner el nombre en es... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                              ...
                              children: [
                                Flexible(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'odfq1nim' /* ¿Este medicamento ha mejorado ... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'cp9spule' /* nombre del medicamento */,
                                          ),
                                          hintStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'ytdwx3ku' /* Recuerda utilizar las tíldes e... */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    _model
                                                                        .nombreMed = FFLocalizations.of(context).languageCode ==
                                                                            'en'
                                                                        ? getJsonField(
                                                                            listItem,
                                                                            r'''$.nombre_en''',
                        ...
                        if ((_model.nombreMed == null ||
                                _model.nombreMed == '') &&
                            (FFAppState().diarioSuenoUltMed != 'no'))
                          Container(
                            width: 350.0,
                            height: 120.0,
                            decoration: BoxDecoration(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Flexible(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'mo74zsty' /* O usar el del último diario re... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'xahavw18' /* Aquí puedes agregar notas sobr... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .labelMedium
